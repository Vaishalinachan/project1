...
`;
         ...
         const options = {
          ...
          if(response.ok===true){
            setValues({...allValues,jobList:data.jobs })
          }
      }
...
const retriveEmpValue=(value,isChecked)=>{
    ...
    return(
        <div>
           ...
           <div className='filter-display-all-jobs-cont'>
            ...
            <div className='display-all-job-cont'>
               <input onKeyDown={onChangeUserIn} placeholder='Search' type="Search" className='form-control my-input'/>
